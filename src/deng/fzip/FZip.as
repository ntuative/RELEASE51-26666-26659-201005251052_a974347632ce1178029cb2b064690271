package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_500 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_94 = parseIdle;
      ...
      {
         if(var_500.parse(param1))
         {
            var_46.push(var_500);
            if(false)
            {
               var_130["null"] = var_500;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1420,var_500));
            var_500 = null;
            if(var_94 != parseIdle)
            {
               var_94 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_46 != null && var_130 != null && param1 < var_46.length)
         {
