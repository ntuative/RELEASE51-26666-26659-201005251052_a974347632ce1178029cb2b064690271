package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_23:String = "client.init.volter.retry";
      ...
      {
         trackLoginStep(const_9);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_3,const_7,null);
      }
