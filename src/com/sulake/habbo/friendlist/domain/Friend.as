package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1611:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_589 = param1.gender;
         var_706 = param1.online;
         var_1299 = param1.followingAllowed && param1.online;
         var_300 = param1.figure;
         var_1320 = param1.motto;
         var_1319 = param1.lastAccess;
         var_1263 = param1.categoryId;
         var_1318 = param1.realName;
