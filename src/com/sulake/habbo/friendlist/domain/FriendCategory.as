package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_228.length / const_325);
      }
      ...
      {
         if(this.var_848 >= this.getPageCount())
         {
            this.var_848 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_848 + 1) * const_325,this.var_228.length);
      }
