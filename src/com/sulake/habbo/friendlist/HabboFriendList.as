package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1582:OpenedToWebPopup;
      
      private var var_880:IAvatarRenderManager;
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_364.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_364.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_401.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_364 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_92.addCategory(new FriendCategory(FriendCategory.const_965,getText("friendlist.friends")));
         var_92.addCategory(new FriendCategory(FriendCategory.const_490,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_533)
         {
            var_533 = new Timer(120000);
            var_533.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_533.start();
         }
         getBuddyRequests();
         registerListeners();
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_533.stop();
            var_533.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_533 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_880)
         {
            var_880.release(new IIDAvatarRenderManager());
            var_880 = null;
         }
         if(var_927)
         {
            var_927.release(new IIDHabboNotifications());
            var_927 = null;
         }
         if(var_190)
         {
         ...
         if(var_625)
         {
            var_625.release(new IIDSessionDataManager());
            var_625 = null;
         }
         super.dispose();
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1583.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_364.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_625.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_625.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_364.limit)
         {
            var_364.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_401.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_880.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_364.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_401.findTab(FriendListTab.const_88);
      ...
      {
         var_927 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1582 == null)
         {
            var_1582 = new OpenedToWebPopup(this);
         }
         var_1582.show(x,y);
      }
