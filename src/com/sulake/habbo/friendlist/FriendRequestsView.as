package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1447:String = "no_reqs_info";
       
      
      private var var_1476:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1475:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_296 && _loc4_.state != FriendRequest.const_298)
            {
      ...
      {
         var_1476 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1475 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1475.procedure = onDismissAllButtonClick;
         var_1476.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_866)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1476,_loc1_);
         setEnabled(var_1475,_loc1_);
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_298;
         var _loc3_:DeclineBuddyMessageComposer = new DeclineBuddyMessageComposer();
