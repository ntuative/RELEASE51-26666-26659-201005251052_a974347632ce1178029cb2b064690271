package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_139,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_68,showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_141,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_139,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_68,showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_141,showPollContent);
      }
