package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1704:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1154 != null && var_1154.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_796 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_796 += param1.height + const_1703;
            return fit(param1);
         }
         param1.offset(_offsetX,var_796);
         _offsetX += param1.width + const_1704;
         return true;
      }
