package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1726:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1718:String = "level";
      
      private var var_107:IItemListWindow;
      
      private const const_1719:String = "energy";
      
      private var var_1196:Map;
      
      private const const_1725:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1720:uint = 3355443;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_230 != null)
         {
            var_107 = var_230.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_107 == null || var_230 == null || var_64 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1196.getValue(var_646) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1718,param1.level,param1.levelMax);
         updateStateElement(const_1723,param1.experience,param1.experienceMax);
         updateStateElement(const_1719,param1.energy,param1.energyMax);
         updateStateElement(const_1725,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_646 = param1.id;
         var_1196.remove(param1.id);
         var_1196.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_181 && var_181.getPetId() == var_646)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_477,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1722,const_1721,false);
