package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_511:int = 6;
      
      private static const const_366:int = 10;
      
      private static const const_1129:Number = 18;
      
      private static const const_1463:Number = 10;
      
      private static const const_1464:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1084,var_1085,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1084,var_749,var_1085,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_1084 = param1.userId;
         var_749 = param1.userName;
         var_1085 = param1.userCategory;
         _message = param1.text;
         var_1330 = param1.userX;
         var_205 = param1.userImage;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1329)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_111:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_286:
         ...
         if(var_205 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_205.height);
         }
         ...
         if(var_205 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_205.width;
               _loc28_.height = var_205.height;
               _loc28_.bitmap = new BitmapData(var_205.width,var_205.height,true,0);
               _loc28_.bitmap.copyPixels(var_205,var_205.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_433 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_205.width;
            }
         }
         if(_loc18_ != null)
         {
         ...
         if(_loc20_ != null)
         {
            if(var_1329 == RoomWidgetChatUpdateEvent.const_286)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_749);
            }
            else if(var_1329 == RoomWidgetChatUpdateEvent.const_251)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_749);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_433;
            _loc20_.width = _loc20_.textWidth + const_511;
            _width += _loc20_.textWidth + const_511;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_366 + _loc20_.textWidth + const_511;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1084,var_1085,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1084,var_1085,_roomId,_roomCategory,param1);
      }
