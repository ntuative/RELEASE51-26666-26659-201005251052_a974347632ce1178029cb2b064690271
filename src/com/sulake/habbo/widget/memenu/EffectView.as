package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      {
         super();
         var_185 = new Timer(1000);
         var_185.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_185.stop();
            var_185.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_185 = null;
         }
         _container = null;
         if(_window != null)
