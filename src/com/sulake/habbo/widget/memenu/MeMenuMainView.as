      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_829);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_842));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_742);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_987));
               _widget.hide();
               break;
            case "clothes":
            ...
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_618);
               break;
            case "news":
               if(false && false)
               {
