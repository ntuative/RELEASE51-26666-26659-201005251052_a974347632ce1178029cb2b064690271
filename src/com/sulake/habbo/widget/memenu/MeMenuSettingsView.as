package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_735:MeMenuSettingsViewSlider;
      
      private var var_1559:BitmapData;
      
      private var var_1561:BitmapData;
      
      private var var_736:Number = 1.0;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_545);
         }
         else
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1560 = (_loc5_.content as BitmapData).clone();
         }
         ...
         var_735 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_547));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_736 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1560);
               }
               break;
            case "sounds_on":
               if(var_736 != 1)
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1558);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1560);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1559);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1561);
