package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_511:int = 16;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1967 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1966 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_723 = new Timer(1000,1);
         var_723.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_874 = new Timer(5000,1);
         var_874.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_57,HabboWindowStyle.const_42,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _window.addEventListener(WindowEvent.const_376,onWindowMoved);
         var_1271 = true;
         var_133 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1968 = _loc2_.width + const_511 + _loc6_.width + const_1115;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1114,_loc8_.width) + const_511);
            _loc8_.x = _loc12_;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_513);
