package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1730:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26666-26659-201005251039");
         var_190 = param5;
         var_102 = new Map();
         var_102.add(HabboHelpViewEnum.const_1272,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_150,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_416,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_254,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_245,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_611,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_336,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_534,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_219,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_102.add(HabboHelpViewEnum.const_985,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_102.add(HabboHelpViewEnum.const_754,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1460 = 0 - _loc3_.width;
         var_1459 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_262 == HabboHelpViewEnum.const_150 || false)
         {
            return;
         }
         if(var_398 == null)
      ...
      {
         return var_102.getValue(var_262);
      }
      ...
      {
         var_1731 = param1;
         var _loc2_:IHelpViewController = var_102.getValue(HabboHelpViewEnum.const_150) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_219:
               ...
               break;
            case CallForHelpResultEnum.const_1024:
               showUI(HabboHelpViewEnum.const_985);
               break;
            case CallForHelpResultEnum.const_922:
      ...
      {
         var _loc3_:* = null;
         if(var_262 == HabboHelpViewEnum.const_150)
         {
            return;
         }
         if(true)
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1459;
         _window.width = _loc1_.width + var_1460;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_190 != null)
            {
               var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_381));
      }
