package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_779:FaqCategory;
      ...
      public function FaqIndex()
      {
         ...
         var_779 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_141 = new Map();
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_779.hasItem(param1))
         {
            var_779.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
