package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_482:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_381,onTaskDoneEvent);
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_110));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_211 || var_33.id == const_89))
         {
            showView(const_89);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1459;
         _window.width = _loc2_.width + var_1460;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_653)
         {
            showView(const_211);
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_381,onTaskDoneEvent);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_381:
               var_1069 = true;
               if(var_33 != null && var_33.id == const_482)
               {
                  showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_372:
               if(var_33 != null && var_33.id == const_344)
               {
                  var_1313 = true;
                  disposeWindow();
               }
      ...
      {
         var_1071 = true;
         if(var_33 != null && (var_33.id == const_344 || var_33.id == const_89))
         {
            showView(const_89);
         }
      }
      ...
      {
         return var_1071 && var_1070 && var_1069;
      }
   }
}
