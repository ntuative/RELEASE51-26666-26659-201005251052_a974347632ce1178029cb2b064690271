package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1084:Number = 25;
      ...
      private var var_1000:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_489.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_489.splice(_loc3_,1);
            var_488.splice(_loc3_,1);
         }
         var_488.push(param1.name);
         var_489.push(param2);
         param1.addEventListener(WindowEvent.const_376,windowEventListener);
         param1.addEventListener(WindowEvent.const_229,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_489[var_488.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1000.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1000.getIconLoc(param1.iconId);
      ...
      {
         return var_488[var_489.indexOf(param1)];
      }
      ...
      private function method_5(param1:IWindowContainer, param2:Number, param3:int, param4:String) : Boolean
      {
         if(param1 == null)
         {
            return false;
      ...
      {
         return param1.x + param1.width < const_781 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_781 || param1.desktop.height - param1.y < const_1085;
      }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         _toolbarSize = param5;
         param3.visible = true;
         if(!method_5(param3,param5,param1.windowMargin,param6))
         {
