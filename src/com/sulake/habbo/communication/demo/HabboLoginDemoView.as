package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private const const_1439:String = "fuselogin";
      
      public var name:String = "";
      
      private var _window:IWindowContainer;
      
      private var var_221:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_112:SSOTicket;
      ...
      {
         var_221.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_221.shockwaveClientUrl = var_112.shockwaveClientUrl;
         var_221.ssoTicket = var_112.ticket;
         var_112.removeEventListener(SSOTicket.const_346,onParsedTicketSuccess);
         var_112.removeEventListener(SSOTicket.const_287,onParsedTicketFailure);
         var_112 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1439,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_221 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_221.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_390,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_221.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1439,"/");
         if(_loc5_ != null)
         {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_221.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_221.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_221.habboCommunication.habboWebLogin(name,password);
         var_112 = new SSOTicket(var_221.assets,_loc2_,_loc1_);
         var_112.addEventListener(SSOTicket.const_346,onParsedTicketSuccess);
         var_112.addEventListener(SSOTicket.const_287,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_221.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_221.windowManager.buildFromXML(_loc3_.content as XML);
