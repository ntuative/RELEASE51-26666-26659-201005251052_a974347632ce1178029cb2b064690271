package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_180:HabboHotelView;
      ...
      private var var_2156:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1580:ILogger;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2157)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_755 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_755);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1340,var_2158));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1439,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2156);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1439,"/");
      ...
      {
         var_755 = _habboConfiguration.getKey("sso.ticket",null);
         var_1340 = _habboConfiguration.getKey("flash.client.url","");
         var_2158 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_180 == null)
         {
            var_180 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_755 != null)
         {
            var_62.mode = HabboConnectionType.const_466;
            var_62.initConnection(HabboConnectionType.const_282);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1580 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2156 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_62.mode)
         {
            case HabboConnectionType.const_466:
               _loc6_ = "";
               ...
               var_1088 = _loc4_;
               var_180.loadBannerImage(_loc7_ + "?token=" + var_1088,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_990:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1416:
               var_624 = generateRandomHexString(30);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_180.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1088);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_62.mode = HabboConnectionType.const_990;
            }
         }
         var_62.initConnection(HabboConnectionType.const_282);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
