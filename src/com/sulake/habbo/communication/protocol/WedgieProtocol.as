package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1376:uint = 1;
      
      public static const const_1284:uint = 2;
       
      
      private var var_937:IProtocolDecoder;
      
      private var var_1103:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1103 = new WedgieEncoder();
         var_937 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1376)
            {
               _loc4_.position = 0;
               _loc6_ = var_937.getID(_loc4_);
