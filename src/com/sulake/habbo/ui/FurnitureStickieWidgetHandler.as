package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_530,RoomWidgetStickieSendUpdateMessage.const_650,RoomWidgetStickieSendUpdateMessage.const_400];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_530:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_948);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc10_ = _container.roomSession.method_1 || _container.sessionDataManager.isAnyRoomController;
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_528,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
            ...
            case RoomWidgetStickieSendUpdateMessage.const_400:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_650:
