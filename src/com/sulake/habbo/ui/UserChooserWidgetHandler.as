package com.sulake.habbo.ui
{
   ...
   public class UserChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc5_:int = _container.roomEngine.method_2(_loc1_,_loc2_,RoomObjectCategoryEnum.const_38);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_570,_loc3_));
      }
