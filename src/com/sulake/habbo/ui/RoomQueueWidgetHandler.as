package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_480:
               ...
               {
                  case RoomSessionQueueEvent.const_1036:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_821:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  ...
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1268) + 1;
                  }
               }
               else
               {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_623);
         _loc1_.push(RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_555);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_741);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_623:
               _container.roomSession.quit();
               break;
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_821);
               break;
            case RoomWidgetRoomQueueMessage.const_555:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_1036);
               break;
            case RoomWidgetRoomQueueMessage.const_741:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_230,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_480];
      }
