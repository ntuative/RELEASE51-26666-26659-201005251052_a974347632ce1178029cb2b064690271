   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_156,onUserTags);
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_156,onUserTags);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_721);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_341);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_822);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_872);
               _loc6_.expiration = _loc9_ - (getTimer() - _loc10_) / 60000;
               _loc6_.isWallItem = param1.category == RoomObjectCategoryEnum.const_32;
               _loc6_.method_1 = _container.roomSession.method_1;
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_233)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_610);
                  ...
                  _loc13_.amIOwner = _container.roomSession.method_1;
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1241;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_884;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_847;
                  }
               ...
               {
                  _loc13_.canBeKicked = _container.roomSession.method_1;
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1204);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_614.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_614.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_610);
                  _loc10_ = (_container.roomSession.method_1 || _container.roomSession.isRoomController || _container.sessionDataManager.isAnyRoomController) && _loc15_ != "useradmin" && _container.roomSession.isPrivateRoom && !_loc8_;
               }
            }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_753);
         _loc1_.push(RoomWidgetUserActionMessage.const_671);
         _loc1_.push(RoomWidgetUserActionMessage.const_755);
         _loc1_.push(RoomWidgetFurniActionMessage.const_250);
         _loc1_.push(RoomWidgetFurniActionMessage.const_690);
         _loc1_.push(RoomWidgetFurniActionMessage.const_637);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_704);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_567);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1218);
         _loc1_.push(RoomWidgetPetCommandMessage.const_710);
      ...
      public function dispose() : void
      {
         ...
         if(var_614 != null)
         {
            _loc1_ = var_614.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_614.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_638:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_991,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_651:
               ...
               break;
            case RoomWidgetUserActionMessage.const_753:
            ...
            case RoomWidgetUserActionMessage.const_467:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_704:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_567:
            ...
            case RoomWidgetPetCommandMessage.const_556:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_710:
