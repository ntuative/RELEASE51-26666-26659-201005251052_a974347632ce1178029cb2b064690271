   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_964,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_698,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_462,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_110,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_698,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_194,onCreditBalance);
         }
         var_11 = _container.inventory;
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_930,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_972,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_462,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_110,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_110:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_110));
               break;
            case HabboHelpTutorialEvent.const_462:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_410));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_581);
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_615);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_695);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_519);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_658);
         _loc1_.push(RoomWidgetStopEffectMessage.const_748);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1369);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1029);
         _loc1_.push(RoomWidgetToolbarMessage.const_549);
         _loc1_.push(RoomWidgetToolbarMessage.const_585);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_311);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1343);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_878);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_604);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_687);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_547);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1320);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_545);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_715);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_723);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_719));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_687:
               ...
               break;
            case RoomWidgetWaveMessage.const_581:
               if(_container != null && false)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_712:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_615:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_658:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_943)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_230,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_519:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_998:
                        _catalog.openCatalogPage(CatalogPageName.const_1421,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_987:
                        var_11.toggleInventoryPage(InventoryCategory.const_275);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1228:
                        var_11.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1231:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_748:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_604:
               ...
               break;
            case RoomWidgetToolbarMessage.const_549:
               ...
               if(var_190)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_585:
               ...
               if(var_190 && false)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_373,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_311:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_372));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_547:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_545:
            ...
            case RoomWidgetStoreSettingsMessage.const_715:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_317,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_723:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_387));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_353:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_684));
               break;
            default:
