package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_917:Number = 0.0;
      
      private var var_529:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_520,RoomWidgetChatSelectAvatarMessage.const_633];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_146,_container.roomSession,0,"Version 26666-26659-201005251039");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_917 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_917);
            }
            if(var_529 == null)
            {
               var_528.x = 0;
               var_528.y = 0;
               var_528.z = 0;
               var_529 = _loc4_.getScreenPoint(var_528);
               var_917 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_528.x = 0;
            var_528.y = 0;
            var_528.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_528);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_529.x || _loc8_.y != var_529.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_529,_loc5_));
