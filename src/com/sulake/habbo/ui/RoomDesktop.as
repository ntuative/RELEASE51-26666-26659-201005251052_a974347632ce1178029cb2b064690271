package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_630:IAvatarRenderManager = null;
      ...
      private var var_183:IToolTipWindow;
      
      private var var_369:ISessionDataManager = null;
      
      private var var_2221:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         var_631 = new Map();
         var_632 = new Map();
         var_182 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_408,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_693,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_766 = _roomEngine.loadRoomResources(var_38.roomResources);
            if(false)
            {
               var_1362 = false;
         ...
         {
            var_1363 = !var_258.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_287[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_57 != null)
         {
            ...
            {
               _loc4_ = var_57.getWithIndex(_loc1_) as IRoomWidget;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(var_444 != null)
         {
            ...
            {
               _loc5_ = var_444.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_408,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_693,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_805 = null;
         ...
         if(var_190 && false)
         {
            ...
            var_190.events.removeEventListener(HabboToolbarEvent.const_60,onHabboToolbarEvent);
         }
         var_190 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2221);
      ...
      {
         var_182.setLayout(param1,_windowManager);
         if(var_190 != null)
         {
            var_182.method_13 = var_190.size;
            var_182.toolbarOrientation = var_190.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_287[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_183 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_183.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         var_182.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = var_631.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     var_631.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = var_632.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     var_632.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_182.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_182 != null)
         {
            var_182.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_653:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_324,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_672 != null && _loc3_ == RoomObjectCategoryEnum.const_38)
               {
            ...
            case RoomEngineObjectEvent.const_426:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_240,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_115:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1034,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = var_632.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_182.roomViewRect;
         var _loc3_:int = _loc2_.width;
         var _loc4_:int = _loc2_.height;
         var _loc5_:int = 0;
         if(var_287.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_535);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_757);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_745);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_703);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_351);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_419:
               ...
               var_183 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_330,WindowStyle.const_301,WindowParam.const_93) as IToolTipWindow;
               var_183.setParamFlag(WindowParam.const_52,false);
      ...
      {
         if(var_18 != null && var_38 != null && var_1363 && var_1362)
         {
      ...
      {
         if(var_766 == null || false)
         {
            return;
         }
         var _loc2_:int = var_766.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_766.splice(_loc2_,1);
         }
         if(false)
         {
            var_1362 = true;
      ...
      {
         var _loc3_:IWindowContainer = var_182.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = var_631.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
