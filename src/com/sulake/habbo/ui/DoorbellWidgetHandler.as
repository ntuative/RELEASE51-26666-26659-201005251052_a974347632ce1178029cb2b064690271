package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_113:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_608,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_143:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_143,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_740];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_740:
      ...
      {
         return [RoomSessionDoorbellEvent.const_113,RoomSessionDoorbellEvent.const_143,RoomSessionDoorbellEvent.const_58];
      }
