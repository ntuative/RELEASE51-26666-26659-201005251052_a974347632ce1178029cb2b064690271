package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = _container.roomEngine.method_2(_loc1_,_loc2_,RoomObjectCategoryEnum.const_34);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_341);
         ...
         _loc9_ = _container.roomEngine.method_2(_loc1_,_loc2_,RoomObjectCategoryEnum.const_32);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_584,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
