package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1628:IIssueBrowserView;
      
      private const const_1731:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1733:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1627:IIssueBrowserView;
      
      private const const_1736:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1732:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_247:ITabContextWindow;
      
      private var var_1629:PickedIssuesView;
      
      private var var_378:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_247 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_247.numTabItems)
            {
               _loc5_ = var_247.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_247.selector.getSelectableByName("open_issues");
         var_247.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_378.view.width = var_247.container.width;
         var_378.view.height = var_247.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1732:
               if(var_1627 == null)
               {
                  var_1627 = new MyIssuesView(issueManager,this,var_247.container);
               }
               return var_1627;
            case const_1731:
               if(var_1628 == null)
               {
                  var_1628 = new OpenIssuesView(issueManager,this,var_247.container);
               }
               return var_1628;
            case const_1733:
               if(var_1629 == null)
               {
                  var_1629 = new PickedIssuesView(issueManager,this,var_247.container);
               }
               return var_1629;
            default:
               return null;
