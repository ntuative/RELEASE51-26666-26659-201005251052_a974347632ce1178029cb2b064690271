package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_2150.clone());
      ...
      {
         var_2150 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_50 = IItemListWindow(var_56.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1276;
      }
   }
}
