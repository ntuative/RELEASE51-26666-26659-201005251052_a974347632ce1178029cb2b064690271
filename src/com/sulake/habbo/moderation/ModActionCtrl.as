package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_682:OffenceCategoryData;
      ...
      private var var_681:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_821 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_820 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_819.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1183,var_396.text,getBanLength(),var_1184));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_819.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1183,var_396.text,var_1184));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_682 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1183,var_396.text,var_1184));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_682 != null;
         if(this.var_681 != null)
         {
            var_56.findChildByName("offence_txt").caption = this.var_681.name;
            var_56.findChildByName("offence_category").visible = true;
         }
         else if(this.var_682 != null)
         {
            this.refreshButtons("offences_cont",2,var_682.offences,var_821,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_820,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_681 = var_682.offences[_loc3_];
         var_396.text = var_681.msg;
         var_319 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_56.caption = "Mod action on: " + var_1443;
         ...
         var_819 = IDropMenuWindow(var_56.findChildByName("banLengthSelect"));
         prepareBanSelect(var_819);
