package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_389:PartSetsData;
      
      private var var_1426:PartOffsetData;
      
      private var var_793:AvatarActionManager;
      
      private var var_170:IAssetLibrary;
      
      private var var_792:IAssetLibrary;
      
      private var var_1673:AvatarRenderManager;
      
      private var var_295:FigureData;
      
      private var var_570:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_666:String;
      
      private var var_1427:AvatarStructureDownloadSet;
      
      private var var_1146:Array;
      
      private var var_665:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_389 = new PartSetsData();
         var_570 = new AnimationData();
         var_1427 = new AvatarStructureDownloadSet();
         var_665 = new AnimationManager();
         var_666 = param4;
         var_1426 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_793.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_666)
         {
            case AvatarType.const_87:
               _loc1_ = var_170.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_389.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_170.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_570.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_170.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_170.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_389.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_170.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_570.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_170.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_295.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_793.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_295.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_793.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_665.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_389.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_389.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1406[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_793.getDefaultActionType();
         var _loc9_:Array = var_389.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_665.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_570.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_389.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_389.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_666 + " ready to go!");
         if(var_666 == AvatarType.const_87)
         {
            var_389.getPartDefinition("ri").appendToFigure = true;
            var_389.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_87:
               if(var_170.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_170.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_170.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_170.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_87:
               if(var_170.hasAsset(_loc5_))
               {
                  var_170.removeAsset(var_170.getAssetByName(_loc5_));
               }
               var_1427.add(new AvatarStructureDownload(var_170,_loc5_,var_295));
               break;
            case AvatarType.PET:
         }
         var_1427.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_665.getAnimation(param1);
      }
      ...
      {
         var_793 = new AvatarActionManager(var_170,var_666);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1146 = var_295.getMandatorySetTypeIds();
         return var_1146;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_792.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_792.getAssetByName("dance" + _loc1_).content as XML;
            var_665.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_792.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_792.getAssetByName("fx" + _loc1_).content as XML;
            var_665.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var_1426.loadOffsets(var_792);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_793.sortActions(param1);
      }
   }
}
