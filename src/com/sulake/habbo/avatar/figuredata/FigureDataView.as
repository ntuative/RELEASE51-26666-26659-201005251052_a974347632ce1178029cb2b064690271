package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1082 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_335 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_335 && var_1082)
         {
            var_335.bitmap = new BitmapData(var_335.width,var_335.height,true,16777215);
            var_335.bitmap.copyPixels(var_1082,var_1082.rect,new Point(0,0 - 0 - 8));
            var_335.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
