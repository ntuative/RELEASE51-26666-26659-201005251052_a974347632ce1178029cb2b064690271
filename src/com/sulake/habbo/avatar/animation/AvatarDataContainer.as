package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1497:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1501,var_1497,var_1500,_alphaMultiplier);
         var_1010 = generatePaletteMapForGrayscale(var_1806,var_1805);
      }
      
      public function get reds() : Array
      {
         return var_1010.getValue("reds") as Array;
      }
      ...
      {
         return var_1010.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1010.getValue("greens") as Array;
      }
      ...
      {
         return var_1010.getValue("alphas") as Array;
      }
