package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1631:IWindowContainer;
      
      public static var var_1402:IWindowContainer;
      
      public static var var_2296:int = 6710886;
      ...
      private var var_511:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_512:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1044 = [];
         var_1034 = [AvatarEditorFigureCategory.const_525,AvatarEditorFigureCategory.const_47,AvatarEditorFigureCategory.const_232,AvatarEditorFigureCategory.const_548,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_96];
         super();
         var_29 = param1;
         ...
         if(var_1631 == null)
         {
            ...
            var_1631 = var_29.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1536 == AvatarEditorSideCategory.const_96 || var_1963))
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_512)
         {
            ...
            var_512 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_512.procedure = stripClubDialogEventProc;
            var_512.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_511 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_511.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1044.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_511.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_511.numSelectables)
               {
                  var_511.getSelectableAt(_loc6_).x = var_511.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1034);
         }
         if(param1.length != var_1044.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1044.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_738:
               break;
            case AvatarEditorSideCategory.const_435:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_435);
               break;
            case AvatarEditorSideCategory.const_96:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_96);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      {
         if(var_1536 == AvatarEditorSideCategory.const_96)
         {
            var_1963 = false;
         ...
         {
            setSideContent(AvatarEditorSideCategory.const_96);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_262 = param1;
         var_511.setSelected(var_511.getSelectableByName(param1));
         _window.invalidate();
      }
