package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_440:AssetAliasCollection;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_206.getValue(AvatarType.const_87) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_206.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_440 = new AssetAliasCollection(_loc1_);
         var_365 = new PetDataManager(_loc1_,this);
         var_759 = new PaletteManager(_loc1_);
         ...
         var_206.add(AvatarType.const_87,_loc3_);
         _loc3_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc3_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_206.add(AvatarType.PET,_loc3_);
      }
      
      public function set mode(param1:String) : void
      {
         var_718 = param1;
         if(var_718 == RenderMode.const_1168)
         {
            init();
         }
         if(var_718 == RenderMode.const_1409)
         {
            init();
      ...
      {
         var _loc6_:* = !var_365.assetsReady(param1);
         var _loc7_:String = var_365.createAvatarFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = var_206.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         if(!_loc6_)
         {
            return new AvatarImage(_loc8_,var_440,_loc7_,param4,AvatarType.PET);
         }
         if(param5 != null)
         {
            var_929.push(param5);
         }
         return new TemporaryAvatarImage(_loc8_,var_440,_loc7_,param4,AvatarType.PET,_assets);
      }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = var_206.getValue(AvatarType.PET);
         _loc2_.init();
      ...
      {
         return var_440.getAssetByName(param1);
      }
      ...
      {
         var _loc2_:AvatarStructure = var_206.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:AvatarStructure = var_206.getValue(AvatarType.const_87) as AvatarStructure;
         if(_loc4_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc4_,var_440,param1,param2,AvatarType.const_87,param3);
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_87:
               _loc3_ = var_206.getValue(AvatarType.const_87) as AvatarStructure;
               break;
            case AvatarType.PET:
               _loc3_ = var_206.getValue(AvatarType.PET) as AvatarStructure;
               break;
            default:
