package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_692.width,var_692.height,true,0);
            _loc1_.bitmap.copyPixels(var_692,var_692.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_830.width,var_830.height,true,0);
            _loc5_ = var_830.clone();
            _loc5_.colorTransform(_loc5_.rect,var_691.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_693.width,var_693.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_693,var_693.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
