package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_710 >= 0 && var_174.length > var_710)
         {
            _loc2_ = var_174[var_710];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_174.length > param1)
         {
            _loc3_ = var_174[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_194.length)
         {
            ...
            {
               if(_loc7_.length > var_194[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_194[param2],param2);
         var_194[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_194[param1])
         {
            return null;
         }
      ...
      {
         return var_174[var_710] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_194 = new Array(param1.length);
         var _loc3_:int = 0;
