   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_155,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_180,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_172,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_174,_windowManager,_assetLibrary);
         ...
         if(_model && var_147 == "")
         {
            _model.switchCategory(FigureData.const_155);
         }
      }
