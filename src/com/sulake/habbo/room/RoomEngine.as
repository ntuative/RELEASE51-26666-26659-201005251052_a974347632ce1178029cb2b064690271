package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_292:String = "object_icon_sprite";
      ...
      private static const const_1077:String = "tile_cursor";
      
      private static const const_293:int = -1;
      ...
      private var var_258:IAdManager = null;
      
      private var var_572:NumberBank;
      ...
      private var var_369:ISessionDataManager = null;
      ...
      private var var_683:RoomMessageHandler = null;
      
      private var var_684:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_306 = new Map();
         var_572 = new NumberBank(1000);
         var_994 = new Map();
         var_307 = new Map();
         var_67 = new RoomObjectEventHandler(this);
         var_683 = new RoomMessageHandler(this);
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_535) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_745) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_757) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_703) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_108);
            if(_loc7_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_415 != null)
         {
            var_415.release(new IIDRoomObjectVisualizationFactory());
            var_415 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_684 != null)
         {
            var_684.release(new IIDRoomRendererFactory());
            var_684 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_684.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_951;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_606);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_694);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_560);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_867);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_824) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_988);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_663,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.ROOM_OBJECT_REMOVED,var_114,var_113,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_626,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_699,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            ...
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_258);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_369;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_341,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_351,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_825,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_822,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_872,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_284,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_595,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_26 == null || var_415 == null || var_41 == null || var_684 == null || _communication == null || _habboConfiguration == null || !var_1716)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_293,RoomObjectCategoryEnum.const_70);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1413,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_114,var_113));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_777,RoomObjectCategoryEnum.const_258);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1186);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_292);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1186);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_292);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_415;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               ...
               var_26.events.addEventListener(RoomObjectMouseEvent.const_481,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_175,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_607,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_ACTIVATE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_375,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_403,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_427,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_479,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_474,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_STOP,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_386,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_420,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_465,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_62,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_434,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_404,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_270,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_406,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_299,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_295,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_422,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_1018,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_371,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_455,warningEventHandler);
            }
         }
      }
      ...
      public function method_2(param1:int, param2:int, param3:int) : int
      {
         if(!var_477)
         {
            return 0;
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_208;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_554) != 0)
         {
            return false;
         }
         if(var_67 != null)
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_477 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_648,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_284,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_394);
                     break;
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_312);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_597)
         {
            var_1716 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_341,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_351,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_951,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_284,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_258.events.addEventListener(AdEvent.const_502,showRoomAd);
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_684 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_477 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_505);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_505,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_572.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_394,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_184,param2);
               break;
            case RoomObjectCategoryEnum.const_70:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_157,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_568,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_635,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_634,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_460,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         if(!isRoomObjectContentAvailable(param1) && param5 != null)
         {
            ...
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_1028,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_572.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_776,RoomObjectCategoryEnum.const_258);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_292);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1457 - _loc12_.width / 2;
               _loc11_.y = var_1456 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_426,var_114,var_113,-1,RoomObjectCategoryEnum.const_208));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_293,const_504);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1186);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_292);
            _loc11_ = addOverlayIconSprite(_loc10_,const_292,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1457 - _loc6_.data.width / 2;
               _loc11_.y = var_1456 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1031,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_859,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_975,RoomObjectVariableEnum.const_304,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_597,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_505);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1028);
      ...
      {
         return getRoomObjectBoundingRectangle(var_114,var_113,const_293,RoomObjectCategoryEnum.const_70,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_293,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1002,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_554,1,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_293,const_504,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_554,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_606,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_535,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_757,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_745,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_703,_loc19_);
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_626,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_699,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_460,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_244);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_694,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_560,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_694,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_560,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_867,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_776,const_1077,RoomObjectCategoryEnum.const_258);
         _loc7_.createRoomObject(const_777,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_258);
         return _loc7_;
      }
