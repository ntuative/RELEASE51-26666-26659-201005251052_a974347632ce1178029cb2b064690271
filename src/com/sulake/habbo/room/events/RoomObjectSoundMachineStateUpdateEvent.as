package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_1255:String = "ROSM_JUKEBOX_INIT";
      
      public static const const_1367:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_958:String = "ROSM_DISPOSE";
