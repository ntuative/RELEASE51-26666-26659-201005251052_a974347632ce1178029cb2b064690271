package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1450:int = 255;
      
      private var var_1449:int = 255;
      
      private var var_1179:uint = 16777215;
      
      private var var_992:uint = 16777215;
      
      protected var var_80:RoomPlaneParser = null;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_669:
                  _loc2_.setString(RoomObjectVariableEnum.const_568,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_626:
                  _loc2_.setString(RoomObjectVariableEnum.const_635,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_699:
                  _loc2_.setString(RoomObjectVariableEnum.const_634,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_460:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_244)
                  {
                     _loc8_ = "null";
                  }
                  var_410.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_663:
                  _loc7_ = var_410.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_410.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_941,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_837,int(_loc5_.bgOnly));
            var_1179 = _color;
            var_1450 = var_1397;
            var_992 = _loc11_;
            var_1449 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_80.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1017,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_750,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_80.planeCount)
         {
            if(param1.type == MouseEvent.ROLL_OUT)
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_112,0);
            }
            return;
         }
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_80.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_80.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_80.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_80.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_80.getPlaneNormal(_loc5_);
         var _loc13_:int = var_80.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1217,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1280,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1179,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_112,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_157)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_153 || _loc13_ == RoomPlaneData.const_277)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_814)
         {
            ...
            {
               _loc7_ = var_1179 >> 16 & 255;
               _loc8_ = var_1179 >> 8 & 255;
               _loc9_ = var_1179 & 255;
               _loc10_ = var_992 >> 16 & 255;
               _loc11_ = var_992 >> 8 & 255;
               _loc12_ = var_992 & 255;
               _loc13_ = (_loc2_ - var_814) / var_1448;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1450 + (var_1449 - var_1450) * _loc13_;
               _color = _loc3_;
               var_1397 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_750,_loc3_);
         }
      }
   }
}
