package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1436:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2317:int = -1;
      ...
      protected var var_1439:String = null;
      
      private var var_549:Array;
      
      private var var_550:Array;
      
      private var var_2280:Number = 0.0;
      ...
      protected var var_2310:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_648[param1] = _loc3_;
            var_647[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1439 != null && var_1439.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2317,param1);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1021:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1009:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_2281 != param1 || var_2279 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_648[_loc3_] = "";
               var_647[_loc3_] = false;
               _loc3_--;
            }
            var_2281 = param1;
            var_2279 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2278 != param1 || var_2280 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2317 = _loc3_.getNumber(RoomObjectVariableEnum.const_236);
            ...
            var_1439 = _loc3_.getString(RoomObjectVariableEnum.const_351);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_294 != _loc3_.getUpdateID() || param1 != var_215 || param2 != var_2310)
         {
