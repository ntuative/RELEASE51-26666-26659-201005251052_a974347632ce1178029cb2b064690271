package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1365:int = 360;
      
      private var var_2226:int = 0;
      
      private var var_767:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1365 / 2) % 360 / var_1365;
         ...
         {
            _loc6_ = int(var_242.getKey(_loc5_)) * var_1365;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1021);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1009);
                  break;
               case "DARKEN":
