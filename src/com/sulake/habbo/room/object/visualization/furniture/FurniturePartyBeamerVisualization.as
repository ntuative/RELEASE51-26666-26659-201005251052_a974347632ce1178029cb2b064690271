package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_769:int = 15;
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_985 = new Array();
         var_985.push(Math.random() * _loc2_ * 1.5);
         var_985.push(Math.random() * _loc2_ * 1.5);
         var_983 = new Array();
         var_983.push(1);
         var_983.push(-1);
         var_986 = new Array();
         var_986.push(const_1060);
         var_986.push(const_1061);
         var_984 = new Array();
