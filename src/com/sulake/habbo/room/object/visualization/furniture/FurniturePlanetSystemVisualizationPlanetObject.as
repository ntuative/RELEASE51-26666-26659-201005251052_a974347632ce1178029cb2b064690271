package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var_695 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1258 = param3;
         var_1754 = param4 * 0 * 2 / 360;
         var_1467 = param5 * 0 * 2 / 360;
         _height = param6;
         var_832 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1258 * Math.cos(var_832 + var_1467);
         var _loc4_:Number = var_1258 * Math.sin(var_832 + var_1467);
         var _loc5_:Number = _height;
         var_695.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_695.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_695.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_695.add(param1);
         }
