package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1450:int = 0;
      ...
      private var var_535:BitmapDataAsset;
      
      private const const_1132:int = 3;
      
      private const const_1710:int = 2;
      
      private var var_758:AvatarVisualizationData = null;
      
      private var var_536:BitmapDataAsset;
      ...
      {
         var_758 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_271.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_184);
         var _loc8_:Boolean = false;
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_621);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_655);
         ...
         var _loc13_:int = param2 - var_1341;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_297);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_294 != _loc3_.getUpdateID() || var_215 != param1.scale || var_168 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_393 || var_534 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_534;
            ...
            if(var_300 != _loc7_)
            {
               for each(_loc40_ in var_271.getKeys())
               {
                  _loc41_ = var_271.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_271.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_921);
               _loc6_ = var_758.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
               var_271.add(_loc5_,_loc6_);
               var_300 = _loc7_;
            }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_312);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_288) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_288);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_646);
            _loc6_.appendAction(AvatarAction.const_681,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_401);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_486);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_328,AvatarAction.const_1273[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_864);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_833,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1005);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_890);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_1014,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_620);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_689);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_892,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_936);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1004,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_447);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_491) > 0;
            if(_loc31_ || _loc12_)
            {
            ...
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_869);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_640,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               {
                  case 32:
                     var_536 = _loc6_.getAsset("sh_std_sd_1_0_0");
                     _loc65_ = -8;
                     _loc66_ = -3;
                     break;
                  case 64:
                     var_536 = _loc6_.getAsset("h_std_sd_1_0_0");
                     _loc65_ = -17;
                     _loc66_ = -7;
               }
               if(var_536 != null)
               {
                  _loc35_.asset = var_536.content as BitmapData;
            ...
            var_535 = null;
            _loc35_ = getSprite(const_1710);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_827))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_535 = var_758.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_535 = var_758.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_535 != null)
               {
                  _loc35_.asset = var_535.content as BitmapData;
            ...
            var_838.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_838)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
