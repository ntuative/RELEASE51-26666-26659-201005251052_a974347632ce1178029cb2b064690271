package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IAvatarImageListener
   {
      ...
      private var var_758:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_967);
         var_348.alpha = 0;
         if(_loc9_ > 0)
         {
            _loc16_ = getTimer() - _loc9_;
            if(_loc16_ < AvatarAction.const_959)
            {
               var_348.alpha = int(Math.sin(_loc16_ / 0 * 0) * 255);
               var_348.setExperience(_loc4_.getNumber(RoomObjectVariableEnum.const_891));
               var_534 = const_1132;
            }
         }
         var _loc10_:Boolean = false;
         var _loc11_:String = _loc4_.getString(RoomObjectVariableEnum.const_288);
         switch(_loc11_)
         {
         ...
         var _loc12_:Boolean = var_294 != _loc3_.getUpdateID() || var_215 != param1.scale || var_168 != _loc4_.getUpdateID();
         var _loc13_:Boolean = var_393 || var_534 > 0 || _loc10_;
         if(_loc12_ || _loc13_)
         {
            increaseUpdateId();
            _loc17_ = getTimer();
            ...
            if(var_300 != _loc7_)
            {
               for each(var _loc51_ in var_271.getKeys())
               {
                  _loc31_ = _loc51_;
                  _loc51_;
                  var_271.remove(_loc31_);
               }
               var _loc49_:* = null;
               _loc6_ = null;
               _loc49_;
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_758.getAvatar(_loc7_,param1.scale,this);
               if(_loc6_ == null)
               {
                  return;
               }
               var_271.remove(_loc5_);
            ...
            _loc19_ = _loc4_.getNumber(RoomObjectVariableEnum.const_312);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc4_.getString(RoomObjectVariableEnum.const_288);
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_646);
            _loc6_.appendAction(AvatarAction.const_681,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
               _loc32_ = int(_loc21_);
            ...
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_401);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc33_ = _loc4_.getNumber(RoomObjectVariableEnum.const_486);
               _loc34_ = 3;
               _loc35_ = param2 - _loc33_;
               if(_loc35_ < _loc34_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_328,_loc23_);
               }
            }
            _loc24_ = _loc4_.getNumber(RoomObjectVariableEnum.const_491) > 0;
            if(_loc24_)
            {
            ...
            _loc25_ = _loc6_.getSprites().length + const_782;
            ...
            {
               _loc49_ = _loc6_.getSprites().length + const_782;
               _loc25_ = _loc6_.getSprites().length + const_782;
               _loc49_;
               if(_loc25_ != spriteCount)
               {
               ...
               if(var_536)
               {
                  _loc49_ = var_536.content as BitmapData;
                  _loc26_.asset = var_536.content as BitmapData;
                  _loc49_;
            ...
            _loc26_ = getSprite(const_1710);
            if(false)
            {
               _loc26_.asset = var_348.image;
               _loc26_.offsetX = -20;
               _loc26_.offsetY = -80;
               _loc26_.alpha = var_348.alpha;
            ...
            var_838.push(getTimer() - _loc17_);
            if(false)
            {
               _loc46_ = 0;
               _loc47_ = "[";
               for each(_loc51_ in var_838)
               {
                  _loc48_ = _loc51_;
                  _loc51_;
      ...
      {
         var_758 = param1 as PetVisualizationData;
         createSprites(const_782);
         var_348 = new ExperienceData(var_758);
         return true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_271 != null)
         {
            _loc1_ = var_271.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_271.getValue(_loc2_) as IAvatarImage;
            }
         }
         var_271.dispose();
         if(var_348)
