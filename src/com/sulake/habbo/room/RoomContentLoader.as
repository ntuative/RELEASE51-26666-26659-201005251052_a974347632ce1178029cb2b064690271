package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_294:String = "RCL_PUBLICROOM_";
      
      private static const const_506:String = "wall_place_holder";
      
      private static const const_1082:int = 2;
      
      private static const const_362:String = "place_holder";
      
      private static const const_1081:String = const_362;
      ...
      public static const const_597:String = "RCL_LOADER_READY";
      ...
      private var var_999:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_484 = [];
         _wallItems = [];
         var_1738 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1735 = ["room_public","room_public_park","room_public_pool"];
         super();
         _libraries = new Map();
         _events = new Map();
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_294 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_369.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_171 != null && var_171.hasWorldType(const_294 + param1))
         {
            return var_171.type;
         }
         return param1;
      ...
      {
         return [const_362,const_506,ROOM_CONTENT,const_779,const_778];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_34 || _loc2_ == RoomObjectCategoryEnum.const_32)
         {
            ...
            return int(var_482.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1738.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_192 && _loc5_ != RoomObjectLogicEnum.const_132)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_483.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_575.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1735.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1226);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_481.getValue(param1) as String;
      ...
      private function continueInitilization() : void
      {
         if(var_1737)
         {
            ...
            if(var_999 != null)
            {
               var_999.dispatchEvent(new Event(const_597));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_171 != null)
         {
            return var_171.getWorldHeightScale(const_294 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_575.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_483.add(_loc3_,_loc4_);
               if(var_484.indexOf(_loc7_) < 0)
               {
                  var_484.push(_loc7_);
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               var_481.add(_loc3_,_loc4_);
               if(_wallItems.indexOf(_loc7_) < 0)
               {
                  _wallItems.push(_loc7_);
               }
            }
            _loc8_ = var_482.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_482.remove(_loc7_);
               var_482.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_999 = param1;
         var_1733 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_1736 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_1734 = param2.getKey("public.room.dynamic.download.url","");
         var_1732 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_34 = const_780;
         initFurniData();
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_400 != null)
         {
            var_400.remove(param1);
            var_400.add(param1,param2);
         }
         if(var_399 != null)
         {
            var_399.remove(param2);
            var_399.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_192 && _loc5_ != RoomObjectVisualizationEnum.const_132)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_415.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_294 + param1) == RoomObjectCategoryEnum.const_70)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_171 = var_1193.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_171 != null)
         {
            return var_171.getWorldScale(const_294 + param1);
         }
         return 32;
      }
   }
