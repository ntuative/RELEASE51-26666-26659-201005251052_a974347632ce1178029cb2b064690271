package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_360:int = 0;
      
      private static const const_359:Number = 50;
      
      public static const const_692:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1157 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1157 = 15;
         }
         var_1438 = _window.height;
         var_564 = 4;
         var_391 = 0;
         var_34 = const_360;
         var_190 = param5;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1157;
         if(_window.height < var_1438)
         {
            _window.height = var_1438;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_34)
         {
            ...
            case const_380:
               var_799 += param1;
               _loc2_ = Number(var_799) / Number(var_392["time_fade_in"]);
               if(var_799 > int(var_392["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_768:
               var_981 += param1;
               if(var_981 > int(var_392["time_display"]) && !var_1158)
               {
                  startFadeOut();
               }
               break;
            case const_767:
               var_798 += param1;
               _loc3_ = 1 - Number(var_798) / Number(var_392["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_798 > int(var_392["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_190.orientation == "TOP" ? int(const_359) : 0;
         var _loc4_:int = var_190.orientation == "BOTTOM" ? int(_loc2_.height - const_359) : int(_loc2_.height);
         var _loc5_:int = var_190.orientation == "LEFT" ? int(const_359) : 0;
         var _loc6_:int = var_190.orientation == "RIGHT" ? int(_loc2_.width - const_359) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
