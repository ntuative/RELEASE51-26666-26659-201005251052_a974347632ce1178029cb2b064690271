package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1728:uint = 4.291613146E9;
      ...
      private const const_1727:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_239.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_934;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_934,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_456,var_78,var_1096);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_239.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_286) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_934);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_629[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_628[var_207]);
         _catalog.purchaseProductAsGift(var_456,var_78,var_1096,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_138:
               ...
               for each(_loc7_ in var_228)
               {
                  ...
                  if(_loc5_.length >= const_1727)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2215 = _loc3_.text;
               break;
            case WindowMouseEvent.const_53:
               showSuggestions(false);
               if(var_1354)
               ...
               break;
            case WindowKeyboardEvent.const_563:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_286 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_286 + 1);
                     break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_629 = _loc1_.boxTypes;
            var_628 = _loc1_.ribbonTypes;
            var_934 = var_1526[0];
            _boxIndex = var_629[0];
            var_207 = var_628[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_239.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_286) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_286);
         }
         var_286 = param1;
         if(var_286 < 0)
         {
            var_286 = _loc2_.numListItems - 1;
         }
         if(var_286 >= _loc2_.numListItems)
         {
            var_286 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_286) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_239 == null)
         {
            var_239 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_538 == null)
         {
            var_538 = createWindow("suggestion_list_item") as IWindowContainer;
            var_538.procedure = suggestionsEventHandler;
         }
         if(var_239 == null || var_538 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_239.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_538.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
