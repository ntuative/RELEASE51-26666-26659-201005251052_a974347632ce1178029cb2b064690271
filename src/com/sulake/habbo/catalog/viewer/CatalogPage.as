package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1307:EventDispatcher;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1409 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1409) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_903);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1307;
            _loc2_.init();
         }
         var_1307.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1307.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_903);
      }
