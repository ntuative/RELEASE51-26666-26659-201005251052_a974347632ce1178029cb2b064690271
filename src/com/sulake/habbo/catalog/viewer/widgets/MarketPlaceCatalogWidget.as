package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_888:MarketPlaceOfferData;
      
      private const const_1448:int = 1;
      
      private const const_1716:int = 40;
      ...
      private const const_1717:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_517)
         {
            ...
            var_517 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_517)
         {
            return;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_517 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_517.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1448);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_889 >= var_599.length)
            {
               return true;
            }
            addListItem(var_599.getWithIndex(var_889));
            ++var_889;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_888.offerId);
            }
            return;
         }
