package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1118 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1118 != null)
         {
            var_1118.addEventListener(WindowKeyboardEvent.const_563,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1118.text));
      }
   }
}
