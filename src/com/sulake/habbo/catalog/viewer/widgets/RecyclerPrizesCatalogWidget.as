package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_667[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_667 = recycler.getPrizeTable();
         if(var_667 == null)
         {
            return;
         }
         ...
         var_1156 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_667[0].prizes.length > 0)
         {
            select(var_667[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1156) as IWindowContainer;
