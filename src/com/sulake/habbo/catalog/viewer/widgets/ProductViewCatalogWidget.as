package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1375:IScrollbarWindow;
      
      protected var var_1155:XML;
      
      private var var_1376:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_640 != null)
         {
            var_640.visible = false;
            var_640.destroyGridItems();
         }
         if(var_1375 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1198.text = "${" + _loc3_.name + "}";
            var_1199.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1198.text = "${" + _loc2_.localizationId + "}";
            var_1199.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_459:
                  _loc4_ = var_1376.clone();
                  if(var_640 != null)
                  {
                     var_640.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_640,var_1375,var_1155);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_218:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_328,AvatarAction.const_566);
                              _loc13_.appendAction(AvatarAction.const_640,_loc6_.productClassId);
      ...
      {
         var_1198 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1199 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1608 = new Point(var_89.x,var_89.y);
         var_640 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1375 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_640 == null)
         {
         ...
         var_1376 = _loc2_.content as BitmapData;
