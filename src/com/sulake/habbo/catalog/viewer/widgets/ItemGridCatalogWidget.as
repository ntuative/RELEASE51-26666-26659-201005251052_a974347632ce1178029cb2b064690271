   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_743,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_279,activateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            var_185.stop();
            var_185.removeEventListener(TimerEvent.TIMER,populateItemGrid);
            var_185 = null;
         }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_877 >= 0 && var_877 < page.offers.length)
            {
               _loc4_ = page.offers[var_877];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_459)
         {
            ++var_1541;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1541);
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(var_134)
         {
            var_185 = new Timer(25);
            var_185.addEventListener(TimerEvent.TIMER,populateItemGrid);
            var_185.start();
         }
      }
