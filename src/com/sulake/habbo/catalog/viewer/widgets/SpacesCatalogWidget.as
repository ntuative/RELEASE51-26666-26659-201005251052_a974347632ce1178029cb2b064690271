package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1395:String = "default";
      ...
      private var var_1396:String = "1.1";
      
      private var var_1159:int = -1;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_253 != null && var_255 != null)
         {
            setRoomImage(var_253,var_255);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_195:
               ...
               if(var_299 >= _activeFloorPatterns.length)
               {
                  var_299 = 0;
               }
               var_254 = 0;
               ...
               for each(_loc9_ in var_151.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_668 = _loc9_.children().length();
                  }
               }
            ...
            case const_120:
               ...
               for each(_loc10_ in var_151.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_670 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1395);
               }
               break;
            ...
            case "ctlg_landscape_pattern_next":
               changePattern(const_120,-1);
               break;
            case "ctlg_landscape_pattern_prev":
               changePattern(const_120,1);
               break;
            case "ctlg_landscape_color_prev":
               changeColor(const_120,-1);
               break;
            case "ctlg_landscape_color_next":
               changeColor(const_120,1);
               break;
            case "ctlg_buy_landscape":
               _loc3_ = var_1160[var_298];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1396);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1395,var_1396,64,this,"window_romantic_wide");
