package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1309:IProductData;
      ...
      {
         super();
         var_1311 = param1.productType;
         var_1310 = param1.furniClassId;
         var_1068 = param1.extraParam;
         var_1067 = param1.productCount;
         var_1308 = param1.expiration;
         var_1309 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_85:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1068);
               break;
