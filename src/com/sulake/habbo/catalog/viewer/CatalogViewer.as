package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1613:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_456 != null)
         {
            if(var_456.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_456.window);
            var_456.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1613);
         var_456 = _loc5_;
      ...
      {
         return var_456.dispatchWidgetEvent(param1);
      }
