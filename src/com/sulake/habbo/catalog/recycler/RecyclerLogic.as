package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_801:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1579)
         {
            case RecyclerStatusMessageEvent.const_1242:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1020:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1579 != RecyclerStatusMessageEvent.const_1020;
      }
      
      private function get statusActive() : Boolean
      {
         return var_284 != const_801;
      }
      ...
      {
         return active && var_284 == const_367;
      }
