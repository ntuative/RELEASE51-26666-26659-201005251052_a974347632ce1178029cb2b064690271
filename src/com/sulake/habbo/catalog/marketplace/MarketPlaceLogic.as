package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1737:int = 3;
      
      public const const_1555:int = 2;
      ...
      private var var_2046:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1481,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2041 || param1.furniTypeId != var_2042)
         {
            return;
         }
         var_2046 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1555,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_449)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1706 = _loc3_.creditsWaiting;
         var_202 = new Map();
      ...
      {
         requestOffers(var_2043,var_2044,var_1920,var_2045);
      }
