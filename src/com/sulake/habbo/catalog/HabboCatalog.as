package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_425:ICatalogNavigator;
      ...
      private var var_2048:GiftWrappingConfiguration;
      ...
      {
         return var_369.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2049 && var_520 != null)
         {
            var_520.playSound(HabboSoundTypesEnum.const_1022);
         }
         var_2049 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_369.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = var_369.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_103:
               var_1297 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2048 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_897)
         {
            if(!var_369.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_425 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_118.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_118 == null)
         {
            var_118 = new MarketPlaceLogic(this,_windowManager,_roomEngine);
         }
      }
      ...
      {
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_425.buildCatalogIndex(_loc2_);
         if(var_1059 != "")
         {
            var_425.openPage(var_1059);
            var_1059 = "";
         }
         else
         {
            var_425.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2047 && var_520 != null)
         {
            var_520.playSound(HabboSoundTypesEnum.const_893);
         }
         var_2047 = false;
      }
