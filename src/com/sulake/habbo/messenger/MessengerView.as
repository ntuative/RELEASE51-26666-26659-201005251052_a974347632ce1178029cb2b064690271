package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_915:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_137:HabboMessenger;
      
      private var var_1324:ConversationView;
      
      private var var_14:IFrameWindow;
      
      private var var_432:Timer;
      
      private var var_740:ITextFieldWindow;
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_740.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1324.afterResize();
         this.var_915.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_740.text = "";
         var_137.conversations.addMessageAndUpdateView(new Message(Message.const_573,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      {
         return this.var_915 == null ? 7 : int(this.var_915.getTabCount());
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_915 = new ConversationsTabView(var_137,var_14);
         var_915.refresh();
         var_740 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_740.addEventListener(WindowKeyboardEvent.const_149,onMessageInput);
         var_1324 = new ConversationView(var_137,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_532,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_934,true);
      }
   }
}
