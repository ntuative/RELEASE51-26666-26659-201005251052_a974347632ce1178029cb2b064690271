package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1229 || var_1562 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1563 == 0 || _loc1_ - var_1563 > var_1562)
         {
            if(_connection != null)
            {
      ...
      {
         var_1229 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1562 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
