package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomPasswordInput
   {
      ...
      private var var_944:GuestRoomData;
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:IButtonWindow = _window.findChildByName("RoomObjectAvatarPostureUpdateMessage") as IButtonWindow;
         if(_loc2_ != null)
         {
      ...
      private function onTry(param1:WindowMouseEvent) : void
      {
         ...
         _navigator.goToRoom(var_944.flatId,true,_loc3_);
         hide();
      }
