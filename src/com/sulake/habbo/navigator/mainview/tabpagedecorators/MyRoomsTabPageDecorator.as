package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_540:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_591;
         }
         if(param1 == 3)
         {
            return Tabs.const_553;
         }
         if(param1 == 4)
         {
            return Tabs.const_616;
         }
         return Tabs.const_223;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_540 == null ? 0 : int(var_540.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_540 == null)
         {
            var_540 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_540.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
