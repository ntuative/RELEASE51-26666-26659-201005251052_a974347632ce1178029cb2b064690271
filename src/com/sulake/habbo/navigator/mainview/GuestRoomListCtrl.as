package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_1316:IWindowContainer;
      ...
      private var var_908:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_908 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1316 != null)
         {
            _loc2_ = var_1316.tags[0];
            var_1316.color = getBgColor(_loc2_);
         }
         var_1316 = param1;
      ...
      private function method_11(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(var_2096 - _loc2_.stageX);
         var_2096 = _loc2_.stageX;
         var_2097 = _loc3_ > 2;
      }
      ...
      private function method_7(param1:IWindowContainer, param2:GuestRoomData) : void
      {
      ...
      private function method_6(param1:IWindowContainer, param2:GuestRoomData) : void
      {
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         method_6(param1,param2);
         _navigator.refreshButton(param1,"home",isHome(param2),null,0);
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_188,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_116,null,0);
         method_7(param1,param2);
         var_908.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_280)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_116:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_188:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1311,true);
