package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         var_74.addEventListener(WindowKeyboardEvent.const_149,checkEnterPress);
         var_74.addEventListener(WindowEvent.const_138,checkMaxLen);
         this.var_2337 = var_74.textBackground;
         this._orgTextBackgroundColor = var_74.textBackgroundColor;
         this.var_2335 = var_74.textColor;
      }
      ...
      {
         var_74.textBackground = this.var_2337;
         var_74.textBackgroundColor = this._orgTextBackgroundColor;
         var_74.textColor = this.var_2335;
      }
      ...
      {
         return !var_319 && Util.trim(getText()).length > 2;
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         {
            var_74.text = _loc2_.substring(0,var_1487);
         }
      }
   }
}
