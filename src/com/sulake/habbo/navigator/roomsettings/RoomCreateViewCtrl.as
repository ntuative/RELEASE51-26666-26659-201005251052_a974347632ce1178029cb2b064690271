package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_882:RoomLayout;
      ...
      private var var_1049:TextFieldManager;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         var_40 = new Array();
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,748,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_64,438,"v"));
      ...
      private function prepare() : void
      {
         ...
         var_1049 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         var_1049.goBackToInitialState();
         var_1049.input.textBackgroundColor = 4294967295;
         var_882 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_43,HabboWindowParam.const_72,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1049.getText();
      ...
      {
         var _loc1_:Boolean = var_1049.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_882.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1282 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1282 = true;
            _loc3_.y = 1;
