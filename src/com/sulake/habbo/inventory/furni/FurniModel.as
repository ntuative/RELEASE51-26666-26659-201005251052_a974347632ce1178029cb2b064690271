package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_318:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_516 = new Timer(const_1118,1);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_265;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_419.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_419.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_628)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_189)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_303)
         {
         ...
         if(var_729 == null)
         {
            var_729 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_729.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_265:
               ...
               break;
            case InventorySubCategory.const_1042:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_338);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_318:
                  var_29.toggleInventoryPage(InventoryCategory.const_158);
            }
         }
      }
      ...
      {
         if(var_883 && param1.type == RoomEngineObjectEvent.const_205)
         {
            var_29.showView();
            var_883 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_352 || _loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_303)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_419.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_419 = new Map();
         var_419.add(const_45,new Array());
         var_419.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
