package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_497 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_497.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_497.addGridItemAt(param1,param2);
      ...
      {
         return var_497.removeGridItemAt(param1);
      }
      
      public function addItemToBottom(param1:IWindowContainer) : void
      {
         var_497.addGridItem(param1);
         param1.procedure = itemEventProc;
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            _model.toggleItemSelection(_category,var_497.getGridItemIndex(param1.window));
            var_351 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_33 && var_351 != null && var_351 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_247)
         {
