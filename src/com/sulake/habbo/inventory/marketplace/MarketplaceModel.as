package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1550,var_1551);
         }
      }
      ...
      {
         if(param1 != var_2041 || param2 != var_2042)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1937);
      }
      ...
      public function releaseItem() : void
      {
         ...
         {
            var_29.furniModel.removeLockFrom(var_231.id);
            var_231 = null;
         }
      }
