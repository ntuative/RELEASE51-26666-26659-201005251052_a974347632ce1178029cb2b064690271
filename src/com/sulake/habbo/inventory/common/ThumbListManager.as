package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1001:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_93 = var_584.height;
         var_1002 = param5;
         var_834 = param6;
         var_226 = Math.floor(var_1002 / _thumbWidth);
         var_19 = new BitmapData(var_1002,var_834);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_19.height < var_834)
         {
            _loc12_ = new BitmapData(var_19.width,var_834);
      ...
      private function getList() : Array
      {
         ...
         if(var_1001 != null)
         {
            _loc1_ = var_1001.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_226 * _thumbWidth,var_1002),Math.max(var_491 * var_93,var_834),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_226 && var_19.height < _loc3_.y * var_93)
         {
         ...
         _loc4_ = new Rectangle(_thumbWidth * (var_226 - 1),0,_thumbWidth,var_19.height);
