package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_809:uint = 4284532064;
      
      private static const const_810:uint = 2577770;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_372 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_23.state)
                  {
                     case TradingModel.const_190:
                        if(var_23.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_1006);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_189)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_919)
            {
            ...
            var_372.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_395);
            var_372.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_185)
            {
               var_185.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_185.stop();
               var_185 = null;
            }
            if(var_372 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1615 == null)
         {
            var_1615 = createMinimizedWindow();
         }
         if(!var_2265)
         {
            return var_66;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_185 == null)
         {
            var_185 = new Timer(1000,3);
            var_185.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_185.reset();
         var_185.repeatCount = 3;
         var_185.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_809) : uint(const_810);
            }
