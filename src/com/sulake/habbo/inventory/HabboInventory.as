package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_863:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_405,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_733));
      }
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_158));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_930));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1715);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_315));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_265:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_864.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_864.splice(_loc3_,1);
            }
         }
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_64;
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_265));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_369 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_864.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_47.getValue(InventoryCategory.const_338) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1038 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_275));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_405,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_338,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_369);
         var_47.add(InventoryCategory.const_275,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_47.add(InventoryCategory.const_733,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_369);
         var_47.add(InventoryCategory.const_315,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_47.add(InventorySubCategory.const_265,_loc8_);
         ...
         var_47.add(InventoryCategory.const_158,_loc10_);
