package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2309:BitmapData;
      ...
      protected var var_460:int = 0;
      
      protected var var_1405:String;
      
      private const const_1713:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_381:BitmapData;
      
      private const const_1458:Number = 0.2;
      
      protected var var_1408:Boolean;
      
      private const const_1459:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_628)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1405);
         }
         if(_loc1_.id > 0)
         {
