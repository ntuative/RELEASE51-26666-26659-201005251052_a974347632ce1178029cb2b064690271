package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_497 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_583 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_583.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_583.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_497.removeGridItem(_loc2_.window);
         if(var_313 == _loc2_)
         {
            var_313 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_583.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_497.addGridItem(_loc2_.window);
            var_583.add(param1.id,_loc2_);
            if(var_313 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            ...
            _loc9_ = _model.roomSession.method_1;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
