package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_158 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1206 && param1.type == RoomEngineObjectEvent.const_205)
         {
            var_29.showView();
            var_1206 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_29.roomSession.method_1)
         {
            var_1206 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_38,RoomObjectTypeEnum.const_300,_loc3_.figure);
            var_29.closeView();
            return;
         }
      ...
      {
         if(var_976.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
