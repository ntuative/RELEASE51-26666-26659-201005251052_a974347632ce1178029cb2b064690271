package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1303:Map = new Map();
      
      private static var var_902:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_902.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_902.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_902.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         return var_1303[param1];
      }
      
      public static function addDebugData(param1:String, param2:String) : void
      {
         var_902.remove(param1);
         var_902.add(param1,param2);
      }
