package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_655:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_391 = _loc13_.blend;
            var_558 = _loc13_.treshold;
            if(var_656 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_559 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_122,WindowParam.const_147);
         var _loc2_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_145);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_276)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_347)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         var_656 = param1;
         var_559 = !!var_656 ? uint(var_559 | var_1407) : uint(var_559 & 16777215);
      ...
      {
         var_558 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1822 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_589:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_191:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1370:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1287:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_350:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_661:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_82 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_496,this,null));
         }
      }
      ...
      {
         var_391 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_906);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1011 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_331,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_558);
      }
      
      public function set color(param1:uint) : void
      {
         var_1407 = param1 & 4278190080;
         var_559 = !!var_656 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_80);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_736))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_917;
                  if(testParamFlag(WindowParam.const_314))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_191:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_370,this,null));
                     if(testParamFlag(WindowParam.const_183,WindowParam.const_147))
                     {
                     ...
                     if(var_9 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_266,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_392:
                  var_16.invalidate(this,var_8.union(var_58),WindowRedrawFlag.const_495);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_863,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_259,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_310:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_550,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_237,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_396:
               ...
               case WindowNotifyEvent.const_496:
                  ...
                  while(--_loc7_ > -1)
                  {
                     WindowController(_loc6_[_loc7_]).style = var_82;
                  }
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_80);
                  break;
               case WindowNotifyEvent.const_398:
               ...
               case WindowNotifyEvent.const_237:
                  ...
                  break;
               case WindowNotifyEvent.const_370:
                  var_9.getRegionProperties(null,var_316);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_331:
      ...
      {
         return var_655 != null ? var_655 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_558);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_688,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1011 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_456)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_191,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1201,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_165 && var_558 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1483,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1483,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1292,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_316 = var_9.rectangle.clone();
               var_58.x = var_8.x;
               var_58.y = var_8.y;
               var_58.width = var_8.width;
               var_58.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_487,this,var_9));
            }
            else
            {
               var_316.x = 0;
               ...
               var_316.width = 0;
               var_316.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_826,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,_param,var_16,var_8,null,var_655,properties,var_657.concat(),_id) as WindowController;
         _loc2_.var_558 = var_558;
         _loc2_.var_165 = var_165;
         _loc2_.var_1404 = var_1404;
         _loc2_.var_316 = var_316.clone();
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_438;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_34 == WindowState.const_412)
         {
            return true;
         }
         var_34 = WindowState.const_412;
         ...
         _loc1_.type = WindowNotifyEvent.const_844;
         update(this,_loc1_);
         dispose();
         return true;
      }
