package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1688:String = "_INCLUDE";
      
      public static const const_916:String = "_EXCLUDE";
      
      public static const const_1492:String = "_TEMP";
      
      private static const const_1128:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1127:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_970:Dictionary;
      
      protected var var_1411:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1410:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1135,var_1136);
         var_970 = new Dictionary();
         var_1410 = new Dictionary();
         ParamCodeTable.fillTables(var_970,var_1410);
         var_1411 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1127,"");
         return param1.replace(const_1128,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1135)
            {
               delete var_1135[_loc1_];
            }
            for(_loc1_ in var_1136)
            {
               delete var_1136[_loc1_];
            }
            for(_loc1_ in var_970)
            {
               delete var_970[_loc1_];
            }
            for(_loc1_ in var_1410)
            {
               delete var_1410[_loc1_];
            }
            var_1411.dispose();
            var_1411 = null;
            var_16 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_916) == -1)
                  {
