package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1051:String = "tool_tip_caption";
      
      protected static const const_1434:uint = 500;
      
      protected static const const_759:String = "";
      
      protected static var var_334:Array;
       
      
      protected var var_2308:uint = 0;
      
      protected var var_966:String = "";
      
      protected var var_459:Array;
      
      protected var var_965:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         {
            var_334 = new Array();
            var_334[0] = WindowState.const_102;
            var_334[1] = WindowState.const_79;
            var_334[2] = WindowState.const_86;
            var_334[3] = WindowState.const_66;
            var_334[4] = WindowState.WINDOW_STATE_SELECTED;
            var_334[5] = WindowState.const_99;
            var_334[6] = WindowState.const_76;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1051,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_759));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_980,param1.toolTipDelay != const_1434));
         return param2;
      }
      ...
      {
         if(param1.toolTipCaption != const_759)
         {
      ...
      {
         var_966 = param1 == null ? const_759 : param1;
      }
