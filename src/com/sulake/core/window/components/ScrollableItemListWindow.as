package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1447:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_341)
         {
            ...
            if(var_341)
            {
               var_341.addEventListener(WindowEvent.const_279,scrollBarEventProc);
               var_341.addEventListener(WindowEvent.const_229,scrollBarEventProc);
            }
         }
         return var_341;
      }
      ...
      override public function dispose() : void
      {
         if(var_341)
         {
            var_341.removeEventListener(WindowEvent.const_279,scrollBarEventProc);
            var_341.removeEventListener(WindowEvent.const_229,scrollBarEventProc);
            var_341 = null;
         }
         if(var_813)
         {
