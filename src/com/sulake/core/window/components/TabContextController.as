package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1131:String = "content";
      
      private static const const_1130:String = "selector";
       
      
      private var var_1187:Boolean = false;
      
      protected var var_971:ITabSelectorWindow;
      
      private var var_897:Boolean = false;
      
      protected var var_1636:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1636 == null)
         {
            var_1636 = findChildByTag(TabContextController.const_1131) as IWindowContainer;
         }
         return var_1636;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_971 == null)
         {
            var_971 = findChildByTag(TabContextController.const_1130) as ITabSelectorWindow;
            if(var_971 != null)
            {
               var_971.procedure = selectorEventProc;
            }
         }
         return var_971;
      }
      ...
      {
         return !!var_897 ? selector.iterator : null;
      }
