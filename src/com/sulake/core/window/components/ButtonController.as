package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow
   {
      ...
      protected static const const_357:String = "_BTN_TEXT";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         switch(event.type)
         {
            ...
            case WindowNotifyEvent.const_625:
               try
               {
                  getChildByName(const_357).blend = getChildByName(const_357).blend + 0.5;
               }
               catch(e:Error)
               {
               }
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(getChildByName(const_357));
         if(_loc2_ != null)
         {
            _loc2_.text = caption;
         }
