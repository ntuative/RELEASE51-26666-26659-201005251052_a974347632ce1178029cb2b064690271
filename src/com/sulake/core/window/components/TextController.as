package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2381:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_661 * maxScrollH,var_385 * maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_216)
         {
            if(param2.type == WindowNotifyEvent.const_191)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_980,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_464,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_464,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_752,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_752,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_left",var_70.left,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_top",var_70.top,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_right",var_70.right,PropertyStruct.const_69,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_70.bottom,PropertyStruct.const_69,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_752,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
