package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1154:String = "increment";
      
      private static const const_516:String = "slider_bar";
      
      private static const const_1155:String = "decrement";
      
      private static const const_808:String = "slider_track";
      ...
      protected var var_788:Number = 0.1;
      ...
      {
         return findChildByName(ScrollbarController.const_808) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_947 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_947 != null)
         {
            _loc1_ = findParentByName(var_947) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_947) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1154)
            {
               if(var_21)
               {
                  var_644 = true;
            ...
            else if(param2.name == ScrollbarController.const_1155)
            {
               if(var_21)
               {
                  var_644 = true;
            ...
            else if(param2.name == ScrollbarController.const_808)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_912)
         {
