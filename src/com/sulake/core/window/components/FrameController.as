package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1109:String = "_HEADER";
      ...
      private static const const_1108:String = "_CONTENT";
      
      private static const const_786:String = "margin_left";
      
      private static const const_787:String = "margin_bottom";
      ...
      private var var_1249:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_785,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_787,0 - _loc3_.bottom,PropertyStruct.const_69,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1249 == null)
         {
            var_1249 = findChildByTag(const_1109) as IHeaderWindow;
            if(!var_1249)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_290,false);
         }
      ...
      {
         return content != null && var_1406 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1108) as IWindowContainer;
            if(!var_20)
            {
