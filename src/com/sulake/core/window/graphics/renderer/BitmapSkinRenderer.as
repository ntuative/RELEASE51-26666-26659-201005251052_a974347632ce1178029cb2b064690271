package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_659:Dictionary;
      
      private var var_747:Matrix;
      
      protected var var_658:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_658 = new Dictionary(false);
         var_659 = new Dictionary(false);
         var_747 = new Matrix();
      }
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_658[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_269)
                  {
                     _loc13_.x += _loc16_;
                  }
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_269)
                  {
                     _loc13_.y += _loc17_;
                  }
                  ...
                  {
                     var_747.a = _loc13_.width / _loc19_.width;
                     var_747.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_747);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_747,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_747 = null;
         for(_loc1_ in var_658)
         {
            _loc2_ = var_658[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_658[_loc1_];
         }
         var_658 = null;
         for(_loc1_ in var_659)
         {
            _loc2_ = var_659[_loc1_] as BitmapData;
            _loc2_.dispose();
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_659[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_269)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_269)
               {
