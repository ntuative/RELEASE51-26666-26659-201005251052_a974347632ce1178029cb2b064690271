package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1582:uint = 128;
      ...
      protected var var_660:Boolean;
      
      protected var var_1637:Boolean;
         ...
         if(var_660)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1637,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1637,16777215);
                  }
                  var_387 += bitmap.width * bitmap.height * 4;
               }
