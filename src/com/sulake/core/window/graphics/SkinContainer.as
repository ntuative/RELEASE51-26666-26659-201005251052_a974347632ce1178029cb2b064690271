package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_2177:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1591 = new Dictionary();
         var_2177 = new Dictionary();
         TypeCodeTable.fillTables(var_1591,var_2177);
         var_1346 = new Dictionary();
         var_2178 = new Dictionary();
         StateCodeTable.fillTables(var_1346,var_2178);
         var_537 = new Dictionary();
         var_537["skin"] = BitmapSkinRenderer;
         var_537["bitmap"] = BitmapDataRenderer;
         var_537["fill"] = FillSkinRenderer;
         var_537["text"] = TextSkinRenderer;
         var_537["shape"] = ShapeSkinRenderer;
         var_537["unknown"] = SkinRenderer;
         var_537["null"] = NullSkinRenderer;
         if(var_386 == null)
         {
            var_386 = new Array();
            var_386.push(WindowState.const_66);
            var_386.push(WindowState.const_76);
            var_386.push(WindowState.const_99);
            var_386.push(WindowState.WINDOW_STATE_SELECTED);
            var_386.push(WindowState.const_86);
            var_386.push(WindowState.const_79);
            var_386.push(WindowState.const_102);
            var_386.push(WindowState.const_90);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1591[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_762[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_762[param1] = new Array(SkinContainer.const_804);
         }
         var_762[param1][param2] = param3;
         if(true)
         {
            var_761[param1] = new Array(SkinContainer.const_804);
         }
         var_761[param1][param2] = param4;
      }
