package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      {
         var _loc2_:WindowRendererItem = var_312[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_311.x = _loc3_.dirty.x;
               var_311.y = _loc3_.dirty.y;
               var_311.width = _loc3_.dirty.width;
               var_311.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_311);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_701,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_312[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_312[param1];
         }
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_727);
            var_312[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_701,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_311.x = param2.x - param1.x;
            var_311.y = param2.y - param1.y;
            var_311.width = param2.width;
            var_311.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_35))
            {
               while(param1.testParamFlag(WindowParam.const_35))
               {
                  ...
                  var_311.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_311,WindowRedrawFlag.const_256);
