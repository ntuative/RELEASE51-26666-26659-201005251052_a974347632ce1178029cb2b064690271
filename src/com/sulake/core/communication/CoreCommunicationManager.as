package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_427)
         {
            _loc10_;
            if(var_427[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_732[_loc3_];
      ...
      {
         if(param1 == null || var_427 == null)
         {
            return null;
         }
         return var_427[param1] as IConnection;
      }
      ...
      {
         var _loc2_:Class = var_731[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_427)
         {
            _loc2_ = _loc5_;
            _loc5_;
