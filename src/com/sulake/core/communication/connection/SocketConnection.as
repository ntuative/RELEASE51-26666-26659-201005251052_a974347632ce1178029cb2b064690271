package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1260:int = 10000;
      ...
      private var var_809:IEncryption;
      
      private var var_675:int;
      
      private var var_338:ByteArray;
      ...
      private var var_808:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_296 = param2;
         var_338 = new ByteArray();
         var_808 = new MessageClassManager();
         var_72 = new Socket();
         var_340 = new Timer(const_1260,1);
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_675));
      ...
      private function onConnect(param1:Event) : void
      {
         var_340.stop();
         var_1173 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_675));
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_808.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_809 != null)
         {
            _loc3_ = var_809.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_338.writeByte(var_72.readUnsignedByte());
         }
      }
      ...
      {
         var_296.addConnectionMessageEvent(_id,param1);
      }
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_675));
         dispatchEvent(param1);
      }
      ...
      {
         var_808.registerMessages(param1);
      }
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_675));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = var_568.getMessages(var_338,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = var_808.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = var_296.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = var_296.getMessageParser(parserClass);
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(var_338,offset);
               var_338 = temp;
            }
         }
         catch(e:Error)
      ...
      {
         var_340.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_675));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_340.stop();
         var_1173 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_675));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_809 + "\n");
      }
   }
}
