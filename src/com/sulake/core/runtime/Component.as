package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_1128:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_973:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_188.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_973 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_973);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1128 & const_983)
         {
            if(_loc3_ == 0)
            {
               if(var_188.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_188.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_408 + "]";
      }
