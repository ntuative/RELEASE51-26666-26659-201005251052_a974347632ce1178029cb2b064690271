package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1136:uint = 1;
      
      private static const const_512:uint = 0;
      
      private static const const_805:uint = 2;
       
      
      private var var_764:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_805)
            {
               if(var_764 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_764.errorID,var_764);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_764);
               }
            }
            return _result == const_512;
         }
         return false;
      }
      ...
      public function removeEventListener(param1:String, param2:Function, param3:Boolean = false) : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(_loc4_)
            {
               ...
               {
                  if(_loc6_.callback == param2 && _loc6_.var_2297 == param3)
                  {
      ...
      public function addEventListener(param1:String, param2:Function, param3:Boolean = false, param4:int = 0, param5:Boolean = false) : void
      {
         ...
         else
         {
            ...
            {
               if(_loc8_.callback == param2 && _loc8_.var_2297 == param3)
               {
                  return;
               }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1136) : uint(const_512);
      }
