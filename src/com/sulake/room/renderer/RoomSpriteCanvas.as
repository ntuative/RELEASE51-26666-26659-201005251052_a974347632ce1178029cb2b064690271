package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1441:int = 50;
      ...
      private var var_1722:Number = -1.0E7;
      
      private var var_1723:Number = -1.0E7;
      
      private var var_2382:int = 0;
      
      private var var_480:RoomObjectCache;
      
      private var var_687:int;
      
      private var var_260:Sprite;
      
      private var var_997:IRoomRenderingCanvasMouseListener = null;
      ...
      public function update() : void
      {
         if(var_995 == 0)
         {
            checkMouseHits(var_996.x,var_996.y,MouseEvent.MOUSE_MOVE);
         }
         var_995 = 0;
         ++var_1458;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2382);
      ...
      {
         var _loc11_:Number = param1 - var_687 / 2;
         var _loc12_:Number = param2 - var_686 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         var_224.compress();
         var _loc3_:int = _container.method_2();
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:String = "";
         var _loc7_:* = null;
         var _loc9_:Boolean = false;
         if(var_687 != var_1724 || var_686 != var_1721)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         if(_loc5_ < var_397.length)
         {
            var_397.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_397[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         while(_loc1_ < var_308.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_997 != null)
                  {
                     var_997.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1458,geometry);
                  }
                  else
                  {
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_478.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_478.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1722 || param2 != var_1723)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_478.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_478.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_480.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_480.getObjectCache(param2);
         ...
         _loc13_ += int(var_687 / 2);
         _loc14_ += int(var_686 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_687 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_686))
                  {
