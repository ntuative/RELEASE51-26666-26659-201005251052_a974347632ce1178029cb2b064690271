package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_289:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(var_184 != null)
         {
            while(false)
            {
               _loc1_ = var_184[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_184.length > param1)
         {
            _loc2_ = var_184["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
