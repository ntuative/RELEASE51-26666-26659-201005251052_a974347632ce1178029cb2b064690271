package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_709:Number = 64;
      
      public static const const_1011:Number = 32;
       
      
      private var var_75:Vector3d;
      
      private var var_404:Number = 1.0;
      ...
      private var var_2384:Number = 500.0;
      ...
      private var var_2383:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1510 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_405 != param1 * var_1510)
         {
            var_405 = param1 * var_1510;
            ++var_79;
         }
      }
      ...
      {
         if(var_404 != param1 * var_1512)
         {
            var_404 = param1 * var_1512;
            ++var_79;
         }
      }
      ...
      {
         if(var_407 != param1 * var_1511)
         {
            var_407 = param1 * var_1511;
            ++var_79;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_406 != null)
         {
            ...
            var_406.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_406.add(_loc3_,_loc4_);
            ++var_79;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2383 || _loc3_ > var_2384)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_404,0 * var_407,0 * var_405);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_406 != null)
         {
            ...
            return var_406.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_404,0 * var_407,0 * var_405);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_404,param2.y * var_407,param2.z * var_405);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_404,param3.y * var_407,param3.z * var_405);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_404,param4.y * var_407,param4.z * var_405);
